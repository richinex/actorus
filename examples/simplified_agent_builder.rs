//! Simplified Agent Builder Example
//!
//! Demonstrates the improved AgentBuilder API for creating custom specialized agents.
//! This approach is much cleaner than the verbose tuple-based configuration.
//!
//! Compare this to supervisor_custom_agents.rs to see the improvement.
...
// ============================================================================
// Main - Using Simplified Agent Builder
// ============================================================================
...
async fn main() -> Result<()> {
    ...
    //     "Manages inventory data...".to_string(),
    //     "You are a data management specialist...".to_string(),
    //     data_tools,
    // );

    // ========================================================================
    // AFTER (New Way - Clean and Fluent):
    // ========================================================================

    println!("Building agents with fluent API...\n");
    ...
    // Collect agents into a collection
    ...
    // Build the agent configurations
    ...
    println!("\n=== Advantages of AgentBuilder ===");
    println!("1. Fluent, chainable API - no manual Arc wrapping");
    println!("2. Clear intent with named methods");
    println!("3. Default values for optional fields");
    println!("4. AgentCollection for managing multiple agents");
    println!("5. Less boilerplate, more readable");
    println!("6. Type-safe at compile time");
    println!();
